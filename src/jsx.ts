...
type PointerEvents = 'bounding-box' | 'visiblePainted' | 'visibleFill'
...
type Cursor =
    ...
    | 'inherit'
    | string; /* [<funciri>,]* */
type DominantBaseline = 'auto' | 'text-bottom' | 'alphabetic' | 'ideographic'
...
export type VueAttributeClass = string | { [key: string]: boolean } | Array<string | { [key: string]: boolean }>;
...
export interface HTMLAttributes<T>
    extends AriaAttributes<T>, DOMAttributes<T>, VueRenderAttributes
{
    accessKey?: string;
...
interface SVGAttributes<T> extends
    AriaAttributes<T>, DOMAttributes<T>, VueRenderAttributes
{
...
interface SVGPresentationAttributes {
    ...
    opacity?: number | string;
    paintOrder?: 'normal'
        | 'fill stroke markers' | 'fill markers stroke'
        | 'stroke fill markers' | 'stroke markers fill'
        | 'markers fill stroke' | 'markers stroke fill';
    pointerEvents?: PointerEvents;
    ...
    transform?: string;
    vectorEffect?: 'none' | 'non-scaling-stroke' | 'non-scaling-size'
...
interface SVGAnimateElementAttributes<T> extends
    SVGAnimationValueAttributes, SVGAnimationTimingAttributes, SVGProps<T>
{
}
interface SVGAnimateMotionElementAttributes<T> extends
    SVGAnimationValueAttributes, SVGAnimationTimingAttributes, SVGProps<T>
{
...
interface SVGAnimateTransformElementAttributes<T> extends
    SVGAnimationValueAttributes, SVGAnimationTimingAttributes, SVGProps<T>
{
...
interface SVGTextElementAttributes<T> extends
    SVGPresentationAttributes, SVGTextAttributes, SVGProps<T>
{
    direction?: 'ltr' | 'rtl';
    dx?: number | string;
    dy?: number | string;
...
interface SVGTextPathElementAttributes<T> extends
    SVGPresentationAttributes, SVGTextAttributes, SVGProps<T>
{
...
interface SVGTSpanElementAttributes<T> extends
    SVGPresentationAttributes, SVGTextAttributes, SVGProps<T>
{
    alignmentBaseline?: AlignBaseLine;
    baselineShift?: number | string | 'sub' | 'super';
